...
{
    /// <inheritdoc />
    public partial class AddMigrationAddPrivateMessaging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversationModelId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrivateMessages_Conversations_ConversationModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_ConversationModelId",
