...
{
    public class StudyHallModel : PageModel
    {
        ...
        public StudyHallModel(ApplicationDbContext context)
        {
            _context = context;
        }
        public void OnGet()
        {
            ...
            var StudyHallRoom = _context.Rooms.FirstOrDefault(r => r.Name == RoomName);
            // If the room doesn't exist, create and save it
            if (StudyHallRoom == null)
            {
